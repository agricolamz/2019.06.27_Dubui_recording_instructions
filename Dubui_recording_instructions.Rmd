...
Having this kind of annotation it is possible to use [this script](https://github.com/agricolamz/get_pitch_formants_duration) for extracting pitch, duration and formants.
